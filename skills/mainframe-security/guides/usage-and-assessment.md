# mainframe-security — Usage Instructions & Capability Assessment
...
| 2. Content Completeness | **4** | payloads 1525 + TC 325 + 5 guides; 9 H2 |
| 3. Command Syntax | **3** | Batch assessment — tool availability varies by domain |
| 4. References | **5** | 42 URLs + 13 CVEs |
| 5. MITRE/OWASP Alignment | **5** | 25 ATT&CK T-codes |
| 6. Usability | **3** | 9 H2 + 21 H3 structure |
