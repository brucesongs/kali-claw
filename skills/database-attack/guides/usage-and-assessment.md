# database-attack — Usage Instructions & Capability Assessment
...
| 2. Content Completeness | **4** | payloads 994 + TC 220 + 6 guides; 17 H2 |
| 3. Command Syntax | **3** | Batch assessment — tool availability varies by domain |
| 4. References | **5** | 37 URLs + 2 CVEs |
| 5. MITRE/OWASP Alignment | **1** | 0 ATT&CK T-codes |
| 6. Usability | **4** | 17 H2 + 10 H3 structure |
...
|----|----------|-------------|-----|
| F-DATAB-001 | **P1** | 0 ATT&CK T-codes | Add MITRE mapping |
| F-DATAB-004 | P3 | TC coverage thin（8 test cases） | Add AAA-format test cases |
