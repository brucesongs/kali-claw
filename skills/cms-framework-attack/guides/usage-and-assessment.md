# cms-framework-attack — Usage Instructions & Capability Assessment
...
| 2. Content Completeness | **4** | payloads 1275 + TC 158 + 4 guides; 18 H2 |
| 3. Command Syntax | **3** | Batch assessment — tool availability varies by domain |
| 4. References | **5** | 231 URLs + 23 CVEs |
...
|----|----------|-------------|-----|
| F-CMSF-001 | **P1** | 0 ATT&CK T-codes | Add MITRE mapping |
| F-CMSF-004 | P3 | TC coverage thin（8 test cases） | Add AAA-format test cases |
