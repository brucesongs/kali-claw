# social-engineering — Usage Instructions & Capability Assessment
...
| 2. Content Completeness | **4** | payloads 1645 + TC 246 + 6 guides; 12 H2 |
| 3. Command Syntax | **3** | Batch assessment — tool availability varies by domain |
| 4. References | **5** | 58 URLs + 0 CVEs |
| 5. MITRE/OWASP Alignment | **2** | 1 ATT&CK T-codes |
| 6. Usability | **4** | 12 H2 + 17 H3 structure |
...
|----|----------|-------------|-----|
| F-SOCI-003 | P3 | 0 CVEs | Add known CVEs |
