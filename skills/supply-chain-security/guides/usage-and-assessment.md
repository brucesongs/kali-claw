# supply-chain-security — Usage Instructions & Capability Assessment
...
| 2. Content Completeness | **4** | payloads 1169 + TC 180 + 6 guides; 12 H2 |
| 3. Command Syntax | **3** | Batch assessment — tool availability varies by domain |
| 4. References | **5** | 49 URLs + 0 CVEs |
...
|----|----------|-------------|-----|
| F-SUPP-001 | **P1** | 0 ATT&CK T-codes | Add MITRE mapping |
| F-SUPP-003 | P3 | 0 CVEs | Add known CVEs |
