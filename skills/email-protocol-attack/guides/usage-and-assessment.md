# email-protocol-attack — Usage Instructions & Capability Assessment
...
| 2. Content Completeness | **4** | payloads 1047 + TC 258 + 4 guides; 10 H2 |
| 3. Command Syntax | **3** | Batch assessment — tool availability varies by domain |
| 4. References | **5** | 65 URLs + 8 CVEs |
| 5. MITRE/OWASP Alignment | **2** | 1 ATT&CK T-codes |
| 6. Usability | **3** | 10 H2 + 11 H3 structure |
...
|----|----------|-------------|-----|
| F-EMAI-004 | P3 | TC coverage thin（8 test cases） | Add AAA-format test cases |
