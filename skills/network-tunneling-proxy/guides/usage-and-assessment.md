# network-tunneling-proxy — Usage Instructions & Capability Assessment
...
| 2. Content Completeness | **4** | payloads 1038 + TC 184 + 9 guides; 15 H2 |
| 3. Command Syntax | **3** | Batch assessment — tool availability varies by domain |
| 4. References | **5** | 100 URLs + 0 CVEs |
| 5. MITRE/OWASP Alignment | **4** | 5 ATT&CK T-codes |
| 6. Usability | **4** | 15 H2 + 20 H3 structure |
...
|----|----------|-------------|-----|
| F-NETWOR-003 | P3 | 0 CVEs | Add known CVEs |
| F-NETWOR-004 | P3 | TC coverage thin（8 test cases） | Add AAA-format test cases |
