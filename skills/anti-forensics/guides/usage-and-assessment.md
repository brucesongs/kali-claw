# anti-forensics — Usage Instructions & Capability Assessment
...
| 2. Content Completeness | **4** | payloads 1077 + TC 274 + 4 guides; 13 H2 |
| 3. Command Syntax | **3** | Batch assessment — tool availability varies by domain |
| 4. References | **3** | 16 URLs + 0 CVEs |
| 5. MITRE/OWASP Alignment | **1** | 0 ATT&CK T-codes |
| 6. Usability | **4** | 13 H2 + 16 H3 structure |
...
|----|----------|-------------|-----|
| F-ANTI-001 | **P1** | 0 ATT&CK T-codes | Add MITRE mapping |
| F-ANTI-003 | P3 | 0 CVEs | Add known CVEs |
| F-ANTI-004 | P3 | TC coverage thin（8 test cases） | Add AAA-format test cases |
