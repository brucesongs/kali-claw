# username-profiling — Usage Instructions & Capability Assessment
...
| 2. Content Completeness | **4** | payloads 1675 + TC 271 + 4 guides; 18 H2 |
| 3. Command Syntax | **3** | Batch assessment — tool availability varies by domain |
| 4. References | **5** | 87 URLs + 0 CVEs |
| 5. MITRE/OWASP Alignment | **1** | 0 ATT&CK T-codes |
| 6. Usability | **4** | 18 H2 + 17 H3 structure |
...
|----|----------|-------------|-----|
| F-USER-001 | **P1** | 0 ATT&CK T-codes | Add MITRE mapping |
| F-USER-003 | P3 | 0 CVEs | Add known CVEs |
