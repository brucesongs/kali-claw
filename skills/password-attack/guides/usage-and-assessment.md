# password-attack — Usage Instructions & Capability Assessment

> **Assessment Date**: 2026-09-04 | **Reviewer**: Claude (batch) | **Version**: v0.2.0.2
> **Overall Score**: **77/100 (Good)** | **Wave 6** (batch assessment, no practical validation)
...
| 2. Content Completeness | **4** | payloads 1022 + TC 197 + 8 guides; 18 H2 |
| 3. Command Syntax | **3** | Batch assessment — tool availability varies by domain |
| 4. References | **5** | 30 URLs + 0 CVEs |
| 5. MITRE/OWASP Alignment | **2** | 2 ATT&CK T-codes |
| 6. Usability | **4** | 18 H2 + 3 H3 structure |
...
|----|----------|-------------|-----|
| F-PASS-003 | P3 | 0 CVEs | Add known CVEs |
