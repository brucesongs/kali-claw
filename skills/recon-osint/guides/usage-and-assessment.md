# recon-osint — Usage Instructions & Capability Assessment
...
| 2. Content Completeness | **4** | payloads 939 + TC 501 + 12 guides; 10 H2 |
| 3. Command Syntax | **3** | Batch assessment — tool availability varies by domain |
| 4. References | **5** | 47 URLs + 0 CVEs |
| 5. MITRE/OWASP Alignment | **1** | 0 ATT&CK T-codes |
| 6. Usability | **3** | 10 H2 + 14 H3 structure |
...
|----|----------|-------------|-----|
| F-RECO-001 | **P1** | 0 ATT&CK T-codes | Add MITRE mapping |
| F-RECO-003 | P3 | 0 CVEs | Add known CVEs |
