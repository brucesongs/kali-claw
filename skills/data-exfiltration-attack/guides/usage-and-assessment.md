# data-exfiltration-attack — Usage Instructions & Capability Assessment

> **Assessment Date**: 2026-09-04 | **Reviewer**: Claude (batch) | **Version**: v0.2.0.2
> **Overall Score**: **86/100 (Excellent)** | **Wave 5** (batch assessment, no practical validation)
...
| 2. Content Completeness | **4** | payloads 1156 + TC 905 + 3 guides; 20 H2 |
| 3. Command Syntax | **3** | Batch assessment — tool availability varies by domain |
| 4. References | **5** | 63 URLs + 2 CVEs |
| 5. MITRE/OWASP Alignment | **5** | 16 ATT&CK T-codes |
| 6. Usability | **4** | 20 H2 + 23 H3 structure |
