# firmware-reverse — Usage Instructions & Capability Assessment

> **Assessment Date**: 2026-09-04 | **Reviewer**: Claude (batch) | **Version**: v0.2.0.2
> **Overall Score**: **74/100 (Good)** | **Wave 5** (batch assessment, no practical validation)
...
| 2. Content Completeness | **4** | payloads 1155 + TC 266 + 4 guides; 12 H2 |
...
| 6. Usability | **4** | 12 H2 + 10 H3 structure |
...
|----|----------|-------------|-----|
| F-FIRM-001 | **P1** | 0 ATT&CK T-codes | Add MITRE mapping |
| F-FIRM-003 | P3 | 0 CVEs | Add known CVEs |
| F-FIRM-004 | P3 | TC coverage thin（8 test cases） | Add AAA-format test cases |
