# hardware-security — Usage Instructions & Capability Assessment
...
| 2. Content Completeness | **4** | payloads 1141 + TC 718 + 6 guides; 13 H2 |
| 3. Command Syntax | **3** | Batch assessment — tool availability varies by domain |
| 4. References | **4** | 20 URLs + 0 CVEs |
| 5. MITRE/OWASP Alignment | **2** | 1 ATT&CK T-codes |
| 6. Usability | **4** | 13 H2 + 11 H3 structure |
...
|----|----------|-------------|-----|
| F-HARD-003 | P3 | 0 CVEs | Add known CVEs |
