# bluetooth-rfid-nfc — Usage Instructions & Capability Assessment
...
| 2. Content Completeness | **4** | payloads 953 + TC 258 + 4 guides; 19 H2 |
| 3. Command Syntax | **3** | Batch assessment — tool availability varies by domain |
| 4. References | **4** | 18 URLs + 0 CVEs |
| 5. MITRE/OWASP Alignment | **2** | 1 ATT&CK T-codes |
| 6. Usability | **4** | 19 H2 + 10 H3 structure |
...
|----|----------|-------------|-----|
| F-BLUE-003 | P3 | 0 CVEs | Add known CVEs |
| F-BLUE-004 | P3 | TC coverage thin（8 test cases） | Add AAA-format test cases |
