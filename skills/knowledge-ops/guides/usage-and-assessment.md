# knowledge-ops — Usage Instructions & Capability Assessment
...
| 2. Content Completeness | **4** | payloads 1217 + TC 542 + 6 guides; 16 H2 |
| 3. Command Syntax | **3** | Batch assessment — tool availability varies by domain |
| 4. References | **2** | 5 URLs + 2 CVEs |
| 5. MITRE/OWASP Alignment | **1** | 0 ATT&CK T-codes |
| 6. Usability | **4** | 16 H2 + 13 H3 structure |
...
|----|----------|-------------|-----|
| F-KNOW-004 | P3 | TC coverage thin（8 test cases） | Add AAA-format test cases |
