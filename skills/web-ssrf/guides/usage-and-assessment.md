# web-ssrf — Usage Instructions & Capability Assessment
...
| 2. Content Completeness | **3** | payloads 915 + TC 190 + 7 guides; 18 H2 |
| 3. Command Syntax | **3** | Batch assessment — tool availability varies by domain |
| 4. References | **5** | 362 URLs + 0 CVEs |
...
|----|----------|-------------|-----|
| F-WEBSS-003 | P3 | 0 CVEs | Add known CVEs |
