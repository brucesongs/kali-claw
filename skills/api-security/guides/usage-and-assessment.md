# api-security — Usage Instructions & Capability Assessment
...
| 2. Content Completeness | **3** | payloads 849 + TC 300 + 7 guides; 12 H2 |
| 3. Command Syntax | **3** | Batch assessment — tool availability varies by domain |
| 4. References | **5** | 112 URLs + 0 CVEs |
...
|----|----------|-------------|-----|
| F-APIS-001 | **P1** | 0 ATT&CK T-codes | Add MITRE mapping |
| F-APIS-003 | P3 | 0 CVEs | Add known CVEs |
