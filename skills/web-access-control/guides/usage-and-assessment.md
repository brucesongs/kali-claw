# web-access-control — Usage Instructions & Capability Assessment
...
| 2. Content Completeness | **4** | payloads 1057 + TC 204 + 7 guides; 13 H2 |
| 3. Command Syntax | **3** | Batch assessment — tool availability varies by domain |
| 4. References | **5** | 182 URLs + 0 CVEs |
| 5. MITRE/OWASP Alignment | **1** | 0 ATT&CK T-codes |
| 6. Usability | **4** | 13 H2 + 8 H3 structure |
...
|----|----------|-------------|-----|
| F-WEBA-001 | **P1** | 0 ATT&CK T-codes | Add MITRE mapping |
| F-WEBA-003 | P3 | 0 CVEs | Add known CVEs |
