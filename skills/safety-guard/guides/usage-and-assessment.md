# safety-guard — Usage Instructions & Capability Assessment
...
| 2. Content Completeness | **4** | payloads 1198 + TC 469 + 6 guides; 18 H2 |
...
| 6. Usability | **4** | 18 H2 + 23 H3 structure |
...
|----|----------|-------------|-----|
| F-SAFE-004 | P3 | TC coverage thin（8 test cases） | Add AAA-format test cases |
