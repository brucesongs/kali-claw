# security-misconfiguration — Usage Instructions & Capability Assessment
...
| 2. Content Completeness | **3** | payloads 927 + TC 202 + 9 guides; 16 H2 |
| 3. Command Syntax | **3** | Batch assessment — tool availability varies by domain |
| 4. References | **5** | 180 URLs + 0 CVEs |
| 5. MITRE/OWASP Alignment | **1** | 0 ATT&CK T-codes |
| 6. Usability | **4** | 16 H2 + 14 H3 structure |
...
|----|----------|-------------|-----|
| F-SEMI-001 | **P1** | 0 ATT&CK T-codes | Add MITRE mapping |
| F-SEMI-003 | P3 | 0 CVEs | Add known CVEs |
