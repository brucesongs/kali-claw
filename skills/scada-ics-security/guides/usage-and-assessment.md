# scada-ics-security — Usage Instructions & Capability Assessment
...
| 2. Content Completeness | **4** | payloads 1691 + TC 187 + 8 guides; 13 H2 |
| 3. Command Syntax | **3** | Batch assessment — tool availability varies by domain |
| 4. References | **5** | 33 URLs + 0 CVEs |
| 5. MITRE/OWASP Alignment | **2** | 1 ATT&CK T-codes |
| 6. Usability | **4** | 13 H2 + 36 H3 structure |
...
|----|----------|-------------|-----|
| F-SCAD-003 | P3 | 0 CVEs | Add known CVEs |
| F-SCAD-004 | P3 | TC coverage thin（8 test cases） | Add AAA-format test cases |
