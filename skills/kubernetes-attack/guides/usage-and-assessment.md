# kubernetes-attack — Usage Instructions & Capability Assessment
...
| 2. Content Completeness | **4** | payloads 1243 + TC 302 + 8 guides; 13 H2 |
| 3. Command Syntax | **3** | Batch assessment — tool availability varies by domain |
| 4. References | **5** | 175 URLs + 31 CVEs |
| 5. MITRE/OWASP Alignment | **5** | 9 ATT&CK T-codes |
| 6. Usability | **4** | 13 H2 + 21 H3 structure |
