# council — Usage Instructions & Capability Assessment

> **Assessment Date**: 2026-09-04 | **Reviewer**: Claude (batch) | **Version**: v0.2.0.2
> **Overall Score**: **77/100 (Good)** | **Wave 5** (batch assessment, no practical validation)
...
| 2. Content Completeness | **5** | payloads 1772 + TC 750 + 8 guides; 14 H2 |
| 3. Command Syntax | **3** | Batch assessment — tool availability varies by domain |
| 4. References | **5** | 25 URLs + 2 CVEs |
| 5. MITRE/OWASP Alignment | **1** | 0 ATT&CK T-codes |
| 6. Usability | **4** | 14 H2 + 25 H3 structure |
...
|----|----------|-------------|-----|
| F-COUN-001 | **P1** | 0 ATT&CK T-codes | Add MITRE mapping |
| F-COUN-004 | P3 | TC coverage thin（8 test cases） | Add AAA-format test cases |
