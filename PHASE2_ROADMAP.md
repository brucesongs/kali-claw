...
> **规划日期**：2026-08-06（v0.2.4 更新于 2026-08-08；替代原 v0.2.1 版本，原 Track 2 xAgent 内容已转移）
> **当前版本**：v0.2.4（skill-lint 0 errors / 0 warnings，139/139 clean pass）
...
**kali-claw** 是基于 OpenClaw 框架构建的 AI 渗透测试智能体工作空间，覆盖 **139 个安全技能域**，掌握 Kali Linux 2025-2 全部 518 款安全工具。

经过 Phase 1 全量构建（v0.1.x → v0.2.1，2026-03 ~ 2026-07）和 Phase 2 Track 1 月度质量审查 + Minor Release（v0.2.2 / v0.2.3 / v0.2.3.1-3 / v0.2.4，2026-08），仓库已达到**稳定维护状态**：

- 139/139 SKILL 通过严格化 linter 检查（0 errors, 0 warnings）
...
| 日期 | 内容 | 预估 |
|------|------|------|
| 2026-09-05 | 第 1 次月度审查（v0.2.4 后首次） | ≤2h |
