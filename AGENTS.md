...
> **Current Version**: v0.2.6 (2026-08-29) — **第 2 次月度审查**（35/139 评估；37 findings；skill-lint 0/0/139）。详见 [RELEASE-v0.2.6.md](RELEASE-v0.2.6.md)。
...
_Last updated: 2026-08-29 (v0.2.6)
